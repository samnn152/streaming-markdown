// Modified by animated_streaming_markdown: this embedded copy is view-only
// and does not depend on flutter_math_fork's separate selection subsystem.
...
/// ```
///
/// This embedded renderer is intentionally view-only. Selection is provided by
/// the surrounding Markdown selection engine.
class Math extends StatelessWidget {
  ...
  /// Default fallback function for [Math].
