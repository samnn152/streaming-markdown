// Modified by animated_streaming_markdown: use the embedded package font
// namespace instead of flutter_math_fork's package namespace.
  ...
  final charWidget = ResetDimension(
    ...
    child: RichText(
      text: TextSpan(
        ...
        style: TextStyle(
          fontFamily:
              'packages/animated_streaming_markdown/KaTeX_${font.fontFamily}',
